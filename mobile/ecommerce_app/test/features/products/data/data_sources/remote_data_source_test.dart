...
import '../../helpers/test_helper.mocks.dart' as user_mocks;
...
void main() async {
  ...
  late user_mocks.MockLocalDataSource mockLocalDataSource;

  setUp(() {
    mockLocalDataSource = user_mocks.MockLocalDataSource();
  ...
  final token = await mockLocalDataSource.getAcessToken();
